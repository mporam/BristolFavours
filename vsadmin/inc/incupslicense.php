...
//	mysql_free_result($result);
	...
	if($success){
		...
		if(trim(@$_POST['upsaccount'])!='') $sSQL .= ",adminUPSAccount='" . escape_string(@$_POST['upsaccount']) . "'";
		...
		$upperbound = "999999";
		$lowerbound = "100000";
		if(trim(@$_POST['myupsuser'])!='' && trim(@$_POST['myupspw'])){
			$saveuser = $theuser = trim(@$_POST['myupsuser']);
			$thepw = trim(@$_POST['myupspw']);
		}else{
			...
			while($theuser != "" && $success && $noloops < 5){
				...
				// print str_replace("<","<br />&lt;",$sXML) . "<HR>\n";
				if(@$pathtocurl != ""){
					exec($pathtocurl . ' --data-binary ' . escapeshellarg($sXML) . ' https://www.ups.com/ups.app/xml/Register', $res, $retvar);
					$res = implode("\n",$res);
...
<?php
			  ...
			  <tr> 
                <td colspan="2" width="100%" align="center">
				  ...
				  <p><span style="font-size:10px"><?php print $yyUPStm?></span></p>
                </td>
			  </tr>
            </table>
          </td>
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
        <tr> 
          <td width="100%">
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
			  <tr>
				<td rowspan="20" width="70" align="center" valign="top"><img src="../images/LOGO_S.gif" border="0" alt="UPS" /><br />&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;</td>
...
<option value='US'>United States</option>
			  ...
			  <tr> 
                <td align="center" colspan="2"><p><span style="font-size:10px"><?php print $yyUPSop?> <a href="http://www.ups.com/content/us/en/resources/service/account.html" target="_blank"><?php print $yyClkHer?></a> <?php print $yyUPScl?><br />
				<?php print $yyUPSMI?> <a href="http://www.ec.ups.com" target="_blank"><?php print $yyClkHer?></a>.<br />
				<?php print $yyUPshp?> <a href="http://ups.com/bussol/solutions/internetship.html" target="_blank"><?php print $yyClkHer?></a></span></p>
				</td>
			  </tr>
			  <tr> 
...
<?php	} ?>
			  ...
			  <tr> 
                <td align="center"><p><span style="font-size:10px"><?php print $yyUPSop?> <a href="http://www.ups.com/content/us/en/resources/service/account.html" target="_blank">click here</a> or call 1-800-PICK-UPS.<br />
				<?php print $yyUPSMI?> <a href="http://www.ec.ups.com" target="_blank"><?php print $yyClkHer?></a>.<br />
				<?php print $yyUPshp?> <a href="http://ups.com/bussol/solutions/internetship.html" target="_blank"><?php print $yyClkHer?></a>.</span></p>
				</td>
			  </tr>
