...
$db_username = "eliteweb_bf";  // Your database login username
$db_password = "bsfcart373";  // Your database login password
$db_name = "eliteweb_bristolfavourscart";      // The name of the database you wish to use
